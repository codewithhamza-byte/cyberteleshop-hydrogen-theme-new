...
export interface CollectionContentFragment {
  ...
  spread?: {reference?: any} | null;
  spreadSecondary?: {reference?: any} | null;
}
  ...
  return (
    <Link to={`/collections/${handle}`} prefetch="viewport">
      ...
      >
        ...
        <div className="flex flex-col items-baseline justify-between gap-4 px-6 py-8 sm:px-8 md:px-12 bg-contrast text-primary">
          {heading?.value && (
