...
export type HomepageSeoQueryVariables = StorefrontAPI.Exact<{
  [key: string]: never;
}>;
...
export type HomepageCategoryCollectionsQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;

export type HomepageCategoryCollectionsQuery = {
  collections: {
    nodes: Array<
...
export type CollectionsShowcaseQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;

export type CollectionsShowcaseQuery = {
  hotDeals?: StorefrontAPI.Maybe<
  ...
  >;
  newArrivals?: StorefrontAPI.Maybe<
    Pick<StorefrontAPI.Collection, 'title' | 'handle'> & {
      products: {
        nodes: Array<
          Pick<
  ...
  >;
  bestSelling?: StorefrontAPI.Maybe<
    Pick<StorefrontAPI.Collection, 'title' | 'handle'> & {
      products: {
        nodes: Array<
          Pick<
  ...
  >;
  limitedOffer?: StorefrontAPI.Maybe<
    Pick<StorefrontAPI.Collection, 'title' | 'handle'> & {
      products: {
        nodes: Array<
          Pick<
...
export type FallbackSearchQueryVariables = StorefrontAPI.Exact<{
  query: StorefrontAPI.Scalars['String']['input'];
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;
...
export type CompareProductsQueryVariables = StorefrontAPI.Exact<{
  ids:
...
export type CompareProductsQuery = {
  nodes: Array<
    StorefrontAPI.Maybe<
      Pick<
        StorefrontAPI.Product,
...
> & {
  ...
  >;
  countdownTimer?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Metafield, 'value'>>;
  seo: Pick<StorefrontAPI.Seo, 'description' | 'title'>;
  media: {
    nodes: Array<
...
export type ProductQuery = {
  product?: StorefrontAPI.Maybe<
    ...
    > & {
      ...
      >;
      countdownTimer?: StorefrontAPI.Maybe<
        Pick<StorefrontAPI.Metafield, 'value'>
      >;
      seo: Pick<StorefrontAPI.Seo, 'description' | 'title'>;
      media: {
...
interface GeneratedQueryTypes {
  ...
  '#graphql\n  query homepageCategoryCollections($country: CountryCode, $language: LanguageCode)\n  @inContext(country: $country, language: $language) {\n    collections(first: 100, sortKey: UPDATED_AT) {\n      nodes {\n        id\n        title\n        handle\n        image {\n          altText\n          url\n        }\n      }\n    }\n  }\n': {
    return: HomepageCategoryCollectionsQuery;
    variables: HomepageCategoryCollectionsQueryVariables;
  };
  ...
  '#graphql\n  query FallbackSearch(\n    $query: String!\n    $country: CountryCode\n    $language: LanguageCode\n  ) @inContext(country: $country, language: $language) {\n    products(first: 5, query: $query) {\n      nodes {\n        id\n        title\n        handle\n        priceRange {\n          minVariantPrice {\n            amount\n            currencyCode\n          }\n        }\n        variants(first: 1) {\n          nodes {\n            image {\n              url\n              altText\n              width\n              height\n            }\n          }\n        }\n      }\n    }\n  }\n': {
    ...
    variables: FallbackSearchQueryVariables;
  };
  ...
  '#graphql\n  query CompareProducts($ids: [ID!]!, $country: CountryCode, $language: LanguageCode)\n  @inContext(country: $country, language: $language) {\n    nodes(ids: $ids) {\n      ... on Product {\n        ...ProductCard\n      }\n    }\n  }\n  #graphql\n  fragment ProductCard on Product {\n    id\n    title\n    publishedAt\n    handle\n    vendor\n    productType\n    description\n    tags\n    variants(first: 1) {\n      nodes {\n        id\n        availableForSale\n        image {\n          url\n          altText\n          width\n          height\n        }\n        price {\n          amount\n          currencyCode\n        }\n        compareAtPrice {\n          amount\n          currencyCode\n        }\n        selectedOptions {\n          name\n          value\n        }\n        product {\n          handle\n          title\n        }\n      }\n    }\n  }\n\n': {
    return: CompareProductsQuery;
    variables: CompareProductsQueryVariables;
  };
